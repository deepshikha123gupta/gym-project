...
<h2>SELECT YOUR GENDER</h2><hr style="border:1px solid #f4511e;width:8%;">
	<div class="row">
		<div class="col-md-3"></div>
		<div class="col-md-3">
			<a href="training2.php">
			...
			<div class="centered">MALE</div>
			</a>
		</div>
		<div class="col-md-3">
			<a href="training3.php">
